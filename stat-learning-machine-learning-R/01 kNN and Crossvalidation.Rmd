...
* the variables are in different ranges and should therefore be scaled before *k*NN
...
We use the `caret` package for model-fitting and for cross-validation, testing 5-fold, 10-fold, and leave-one-out cross-validation (CV)
